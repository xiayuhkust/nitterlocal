#!/usr/bin/env python3
"""
Script to synchronize data from SQLite to MySQL.
This script will synchronize both KOL info and tweets.
"""
...
def sync_kol_info(limit=None, test=False):
    ...
    # Build the command
    command = ['python3', 'scripts/database/fixed_update_mysql_kol_info_v3.py', '--no-nodejs']
