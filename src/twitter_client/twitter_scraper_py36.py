#!/usr/bin/env python3
"""
Twitter scraper module for Python 3.6 compatibility.
...
class TwitterScraper:
    ...
    def __init__(self, client_dir=None):
        ...
        # Check if Node.js is installed - Python 3.6 compatible version
        try:
    ...
    def scrape_url(self, url, max_tweets=10, max_replies=30):
        ...
        try:
            # Run the Twitter client - Python 3.6 compatible version
    ...
    def extract_user_id_from_handle(self, handle):
        ...
        try:
            # Run a modified version of the Twitter client that only gets the user ID - Python 3.6 compatible version
